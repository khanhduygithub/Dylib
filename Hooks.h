...
{
    this->GetHp = (int (*)(void *))getRealOffset(oxo("0x54FF7C4"));
    this->Curent_Match = (void *(*)())getRealOffset(oxo("0x55BDBEC"));
    this->GetLocalPlayer = (void *(*)(void *))getRealOffset(oxo("0x2FFD318"));
    this->GetHeadPositions = (void *(*)(void *))getRealOffset(oxo("0x54532A0"));
    this->get_position = (Vector3(*)(void *))getRealOffset(oxo("0x15525D4"));
    this->Component_GetTransform = (void *(*)(void *))getRealOffset(oxo("0x2A67600"));
    this->get_camera = (void *(*)())getRealOffset(oxo("0x915E3D8"));
    this->WorldToViewpoint = (Vector3(*)(void*, Vector3, int))getRealOffset(oxo("0x915DB50"));
    this->get_isVisible = (bool (*)(void *))getRealOffset(oxo("0x16C9914"));
    this->get_isLocalTeam = (bool (*)(void *))getRealOffset(oxo("0x53E1484"));
    this->get_IsDieing = (bool (*)(void *))getRealOffset(oxo("0x53C1168"));
    this->get_MaxHP = (int (*)(void *))getRealOffset(oxo("0x6C9F14C"));
    this->GetForward = (Vector3(*)(void *))getRealOffset(oxo("0x6C98D14"));
    this->set_aim = (void (*)(void *, Quaternion))getRealOffset(oxo("0x53C40A8"));
    this->get_IsSighting = (bool (*)(void *))getRealOffset(oxo("0x551B04C"));
    this->get_IsFiring = (bool (*)(void *))getRealOffset(oxo("0x545C9A0"));
    this->name = (monoString * (*)(void *player)) getRealOffset(oxo("0x6C85C70"));
    this->_GetHeadPositions = (void *(*)(void *))getRealOffset(oxo("0x54532A0"));
    this->_newHipMods = (void *(*)(void *))getRealOffset(oxo("0x5453310"));
    this->_GetLeftAnkleTF = (void *(*)(void *))getRealOffset(oxo("0x5453C20"));
    this->_GetRightAnkleTF = (void *(*)(void *))getRealOffset(oxo("0x5453F40"));
    this->_GetLeftToeTF = (void *(*)(void *))getRealOffset(oxo("0x53AF7B8"));
    this->_GetRightToeTF = (void *(*)(void *))getRealOffset(oxo("0x53AF7B8"));
    this->_getLeftHandTF = (void *(*)(void *))getRealOffset(oxo("0x53C2CCC"));
    this->_getRightHandTF = (void *(*)(void *))getRealOffset(oxo("0x53A10FC"));
    this->_getLeftForeArmTF = (void *(*)(void *))getRealOffset(oxo("0x53C2CD4"));
    this->_getRightForeArmTF = (void *(*)(void *))getRealOffset(oxo("0x53C2CD4"));
}

bool IsGod(void *player){
    return *(bool *)((uint64_t) player + 0xA0);
}

void *get_gameObject(void *Pthis)
{
    return ((void* (*)(void *))getRealOffset(0x1610CB8))(Pthis);
}

static void *GetWeaponOnHand1(void *local) {
    void *(*_GetWeaponOnHand1)(void *local) = (void *(*)(void *))getRealOffset(0x53DA438);
    return _GetWeaponOnHand1(local);
}

static Vector3 Transform_INTERNAL_GetPosition(void *player) {
    Vector3 out = Vector3::zero();
    void (*_Transform_INTERNAL_GetPosition)(void *transform, Vector3 * out) = (void (*)(void *, Vector3 *))getRealOffset(ENCRYPTOFFSET("0x91CCD28"));
...
static Vector3 CameraMain(void *player) {
    return game_sdk->get_position(*(void **)((uint64_t)player + oxo("0x28")));
}
...
public:
    static Vector3 Transform_GetPosition(void *player) {
        Vector3 out = Vector3::zero();
        void (*_Transform_GetPosition)(void *transform, Vector3 *out) = (void (*)(void *, Vector3 *))getRealOffset(oxo("0x91CCD28"));
    ...
    {
        void *(*_Player_GetHeadCollider)(void *players) = (void *(*)(void *))getRealOffset(oxo("0x53C1C70"));
        return _Player_GetHeadCollider(player);
    }

    // Sử dụng Physics.Raycast offset 0x924152C thay vì SingleLineCheck 0x5580870
    static bool Physics_Raycast(Vector3 origin, Vector3 direction, float maxDistance, int layerMask, RaycastHit* hitInfo)
    {
        bool (*_Physics_Raycast)(Vector3, Vector3, RaycastHit*, float, int, int) = 
            (bool (*)(Vector3, Vector3, RaycastHit*, float, int, int))getRealOffset(0x924152C);
        int queryTriggerInteraction = 0; // Ignore
        return _Physics_Raycast(origin, direction, hitInfo, maxDistance, layerMask, queryTriggerInteraction);
    }
    ...
    static bool isVisible(void *enemy) {
        if (enemy != NULL) {
            ...
            RaycastHit hitInfo;
            bool hasHit = Physics_Raycast(Camera, direction, distance, 12, &hitInfo);
            
            if (!hasHit) return true;
            
            void* hitCollider = hitInfo.collider;
            void* enemyCollider = Player_GetHeadCollider(enemy);
            return hitCollider == enemyCollider;
        }
        return false;
    }
};
...
void *GetClosestEnemy()
{
    try
    {
        ...
        if (!Vars.Enable)
            return NULL;
        Dictionary<uint8_t *, void **> *players = *(Dictionary<uint8_t *, void **> **)((long)get_MatchGame + oxo("0xB0"));
        if (!players )
            return NULL;
...
void *GetClosestEnemysilent()
{
    try
    {
        ...
        Dictionary<uint8_t *, void **> *players = *(Dictionary<uint8_t *, void **> **)((long) get_MatchGame + 0xB0);
        if (!players)
            return NULL;
...
void *getItransform(void *itransform) {
    void * (*_itransformNode)(void *_this) = (void*(*)(void*))getRealOffset(0x2A67600);
    return _itransformNode(itransform);
}

static float get_Range(void *pthis)
{
    return ((float (*)(void *))getRealOffset(ENCRYPTOFFSET("0x658C0E4")))(pthis);
}
...
void ProcessAimbot() {
    ...
    if (shouldAim && (!Vars.VisibleCheck || tanghinh::isVisible(closestEnemy))) {
        if (game_sdk->get_IsDieing(closestEnemy) && Vars.IgnoreKnocked) {
            float shortestDistance = 9999.0f;
            void *newTarget = NULL;
            Dictionary<uint8_t *, void **> *players = *(Dictionary<uint8_t *, void **> **)((long)CurrentMatch + oxo("0xB0"));
             if (players) {
              for (int u = 0; u < players->getSize(); u++) {
                void *Player = players->getValues()[u];
...
void get_players()
{
    ...
    try
    {
        ...
        Dictionary<uint8_t *, void **> *players = *(Dictionary<uint8_t *, void **> **)((long)current_Match + 0xB0);
        if (!players )
            return;
