...
{
    // ========== CẬP NHẬT OFFSETS MỚI ==========
    this->GetHp = (int (*)(void *))getRealOffset(0x5CFC584);
    this->get_MaxHP = (int (*)(void *))getRealOffset(0x6C75D98);
    this->Curent_Match = (void *(*)())getRealOffset(0x55BDBEC);
    this->GetLocalPlayer = (void *(*)(void *))getRealOffset(0x55C4DA4);
    this->GetHeadPositions = (void *(*)(void *))getRealOffset(0x54532A0);
    this->get_position = (Vector3(*)(void *))getRealOffset(0x15525D4);
    this->Component_GetTransform = (void *(*)(void *))getRealOffset(0x2A67600);
    this->get_camera = (void *(*)())getRealOffset(0x1566928);
    this->WorldToViewpoint = (Vector3(*)(void*, Vector3, int))getRealOffset(0x915DC30);
    this->get_isVisible = (bool (*)(void *))getRealOffset(0x6C718A8);
    this->get_isLocalTeam = (bool (*)(void *))getRealOffset(0x6DAE024);
    this->get_IsDieing = (bool (*)(void *))getRealOffset(0x53AA18C);
    this->GetForward = (Vector3(*)(void *))getRealOffset(0x89291E0);
    this->set_aim = (void (*)(void *, Quaternion))getRealOffset(0x53C40A8);
    this->get_IsSighting = (bool (*)(void *))getRealOffset(0x53B769C);
    this->get_IsFiring = (bool (*)(void *))getRealOffset(0x551C294);
    this->name = (monoString * (*)(void *player)) getRealOffset(0x1778D2C);
    
    // ========== SKELETON (XƯƠNG) ==========
    this->_GetHeadPositions = (void *(*)(void *))getRealOffset(0x54532A0); // Trùng với GetHeadPositions
    this->_newHipMods = (void *(*)(void *))getRealOffset(0x5453310);       // GetHipTF
    this->_GetLeftAnkleTF = (void *(*)(void *))getRealOffset(0x5453C20);
    this->_GetRightAnkleTF = (void *(*)(void *))getRealOffset(0x5453F40);
    this->_GetLeftToeTF = (void *(*)(void *))getRealOffset(0x53AF7B8);
    this->_GetRightToeTF = (void *(*)(void *))getRealOffset(0x53E0440);
    this->_getLeftHandTF = (void *(*)(void *))getRealOffset(0x53C2CCC);
    this->_getRightHandTF = (void *(*)(void *))getRealOffset(0x53A10FC);
    this->_getLeftForeArmTF = (void *(*)(void *))getRealOffset(0x53C2CD4);
    this->_getRightForeArmTF = (void *(*)(void *))getRealOffset(0x53C2CDC);
}

// ========== CÁC HÀM HỖ TRỢ ==========

// IsGod - Đã sửa offset từ 0xF4C -> 0xA0
bool IsGod(void *player) {
    return *(bool *)((uint64_t) player + 0xA0);
}

// GetGameObject - Đã cập nhật
void *get_gameObject(void *Pthis) {
    return ((void* (*)(void *))getRealOffset(0x1610CB8))(Pthis);
}

// GetWeaponOnHand1 - Đã cập nhật
...
// Get_Range - Đã cập nhật
static float get_Range(void *pthis) {
    return ((float (*)(void *))getRealOffset(0x658C0E4))(pthis);
}

// Transform_INTERNAL_GetPosition - Tối ưu dùng get_position
...
// Camera Main - Đã sửa offset 0x390 -> 0x28
static Vector3 CameraMain(void *player) {
    return game_sdk->get_position(*(void **)((uint64_t)player + 0x28));
}
...
public:
    static Vector3 Transform_GetPosition(void *player) {
       Vector3 out = Vector3::zero();
        void (*_Transform_GetPosition)(void *transform, Vector3 *out) = (void (*)(void *, Vector3 *))getRealOffset(0x15525D4);
        _Transform_GetPosition(player, &out);
        return out;
    }

    static void *Player_GetHeadCollider(void *player) {
        void *(*_Player_GetHeadCollider)(void *players) = (void *(*)(void *))getRealOffset(0x53C1C70);
    ...
    static bool Physics_Raycast(Vector3 camLocation, Vector3 headLocation, unsigned int LayerID, void *collider) {
        bool (*_Physics_Raycast)(Vector3, Vector3, unsigned int, void *) = (bool (*)(Vector3, Vector3, unsigned int, void *))getRealOffset(0x924152C);
...
bool isFov(Vector3 vec1, Vector3 vec2, int radius) {
    int x = vec1.x; int y = vec1.y; int x0 = vec2.x; int y0 = vec2.y;
    if ((pow(x - x0, 2) + pow(y - y0, 2)) <= pow(radius, 2)) return true;
    return false;
}

// ========== GET CLOSEST ENEMY (AIMBOT) ==========
void *GetClosestEnemy() {
    try {
        ...
        // ĐÃ SỬA: 0x148 -> 0xB0
        Dictionary<int, void **> *players = *(Dictionary<int, void **> **)((long)get_MatchGame + 0xB0);
...
void *getItransform(void *itransform) {
    void * (*_itransformNode)(void *_this) = (void*(*)(void*))getRealOffset(0x183B7C8);
...
void ProcessAimbot() {
    ...
    if (shouldAim && (!Vars.VisibleCheck || tanghinh::isVisible(closestEnemy))) {
        if (game_sdk->get_IsDieing(closestEnemy) && Vars.IgnoreKnocked) {
            ...
            void *newTarget = NULL;
            // ĐÃ SỬA: 0x148 -> 0xB0
            Dictionary<int, void **> *players = *(Dictionary<int, void **> **)((long)CurrentMatch + 0xB0);
            if (players) {
                for (int u = 0; u < players->getSize(); u++) {
                    void *Player = players->getValues()[u];
...
void get_players() {
    ...
    try {
        ...
        // ĐÃ SỬA: 0x148 -> 0xB0
        Dictionary<int, void **> *players = *(Dictionary<int, void **> **)((long)current_Match + 0xB0);
        if (!players) return;
        ...
        for (int u = 0; u < players->getSize(); u++) {
            ...
            if (w2sc) {
                // Vẽ Lines
                if (Vars.lines) {
                    if (game_sdk->get_IsDieing(closestEnemy)) draw_list->AddLine(ImVec2(ImGui::GetIO().DisplaySize.x / 2, 0), ImVec2(rect.GetCenter().x, rect.Min.y), ImColor(255, 0, 0));
                    else draw_list->AddLine(ImVec2(ImGui::GetIO().DisplaySize.x / 2, 0), ImVec2(rect.GetCenter().x, rect.Min.y), line_color);
                }
                // Vẽ Box
                if (Vars.Box) {
